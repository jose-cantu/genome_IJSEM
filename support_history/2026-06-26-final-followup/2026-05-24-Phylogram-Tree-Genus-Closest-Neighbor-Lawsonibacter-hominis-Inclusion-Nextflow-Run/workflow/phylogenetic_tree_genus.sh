...
# Define directories
Work_DIR="/mount/britton/Jose/Jobs/Jason/2026-05-24-Phylogram-Tree-Genus-Closest-Neighbor-Lawsonibacter-hominis-Inclusion-Nextflow-Run/workflow-output/work"  
...
nextflow -c phylogenetic_tree_genus.conf -log ./logs/nextflow.log run phylogenetic_tree_genus.nf -profile MAB -resume --sample Pseudo --type_accession ../data/expanded_type_species_plus_closest_neighbors_accessions.txt
